    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 py-16 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center w-full">
        ...
        <div className="lg:col-span-7 flex flex-col items-start gap-8 text-left animate-fade-in-up">
          ...
          <div className="grid grid-cols-3 gap-6 pt-6 pb-2 px-6 w-full max-w-md rounded-2xl bg-white/30 backdrop-blur-md border border-white/50 shadow-[0_8px_30px_rgba(122,27,36,0.12),inset_0_1px_1px_rgba(255,255,255,0.8)]">
            <div>
              <p className="font-serif text-2xl font-bold text-heritage-maroon">Trusted</p>
              <p className="text-xs text-ink/50 uppercase tracking-wider font-sans">By Families</p>
            </div>
            <div>
              <p className="font-serif text-2xl font-bold text-heritage-maroon">University</p>
              <p className="text-xs text-ink/50 uppercase tracking-wider font-sans">Degree Programs</p>
            </div>
            <div>
              <p className="font-serif text-2xl font-bold text-heritage-maroon">Diverse</p>
              <p className="text-xs text-ink/50 uppercase tracking-wider font-sans">Certificate Courses</p>
            </div>
          </div>
        </div>
